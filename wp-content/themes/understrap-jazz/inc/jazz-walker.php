...
class Jazz_Walker extends Walker_Nav_Menu {
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $this->depthCount++; //menu depth count
        ...
        if ( isset( $args->has_children ) && $args->has_children && 0 === $depth && $args->depth !== 1 ) {
            ...
            $atts['class']         = ($this->depthCount % 2 == 0) ?  'dropdown-toggle dropdown-item-even '. $this->depthCount : 'dropdown-toggle dropdown-item-odd '. $this->depthCount;
            $atts['id']            = 'menu-item-dropdown-' . $item->ID;

        } else {
            $atts['href'] = ! empty( $item->url ) ? $item->url : '#';
            // Items in dropdowns use .dropdown-item instead of .nav-link.
            $atts['class'] = ($this->depthCount % 2 == 0) ?  'dropdown-item-even '. $this->depthCount : 'dropdown-item-odd '. $this->depthCount;
